                                ...
                                <tbody>
                                    <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <tr class="gradeX">
                                            ...
                                            <td class="am-text-middle"><?php echo htmlentities($vo['xuehao']); ?></td>
                                            <td class="am-text-middle"><?php echo htmlentities($vo['shenfen']); ?></td>
                          ...
                          <script>
                              function updateStudent()
                              {
                                ...
                                if(!files[0])
                                {
                                  ...
                                  $.ajax({
                                      url       :   "<?php echo url('Student/updateStudent'); ?>",
                                      type      :   "post",
                                      data      :   formData,
                                      dataType  :   "json",
                                      cache     :   false,
...
<script>
    function insert()
    {
        window.location.href = "<?php echo url('student/insert'); ?>";
    }
</script>
