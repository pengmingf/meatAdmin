<?php /*a:7:{s:78:"/www/wwwroot/mfmeat/meatAdmin/application/index/view/buseruser/buser_list.html";i:1557825012;s:69:"/www/wwwroot/mfmeat/meatAdmin/application/index/view/public/base.html";i:1557797260;s:69:"/www/wwwroot/mfmeat/meatAdmin/application/index/view/public/head.html";i:1557889080;s:68:"/www/wwwroot/mfmeat/meatAdmin/application/index/view/public/top.html";i:1557797260;s:70:"/www/wwwroot/mfmeat/meatAdmin/application/index/view/public/style.html";i:1557797260;s:68:"/www/wwwroot/mfmeat/meatAdmin/application/index/view/public/nav.html";i:1557890448;s:69:"/www/wwwroot/mfmeat/meatAdmin/application/index/view/public/foot.html";i:1557797260;}*/ ?>
                ...
                <div class="widget am-cf">
                    ...
                    <div class="widget-body  am-fr">
                                ...
                                <tbody>
                                    <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <tr class="gradeX">
                                            ...
                                            <td class="am-text-middle"><?php echo htmlentities($vo['bname']); ?></td>
                                            ...
                                            <td class="am-text-middle"><?php echo htmlentities($vo['message']); ?></td>
                        ...
                        <script type="text/javascript">
                            ...
                            {
                                $.ajax({
                                    url     :   "<?php echo url('buseruser/update'); ?>",
                                    type    :   "post",
                                    data    :   {'Id':id},
                                    dataType:   "json",
                        ...
                        <div class="am-popup am-popup-inner" style="position: absolute;top: 50%;left: 50%;width:60%;transform: translate(-50%, -50%);margin-left: -6%;margin-top: 10%;height:70%;background-color:#4B5357;" id="my-popup">
                                        ...
                                        <div class="widget-body am-fr">
                                            <form class="am-form tpl-form-border-form tpl-form-border-br" id="form">
                                                <div class="am-form-group">
                                                    ...
                                                    <div class="am-u-sm-9">
                                                        <input type="text" class="tpl-form-input" style="color:gray;" id="bname" name="bname" placeholder="请输入昵称">
                                                ...
                                                <div class="am-form-group">
                                                    ...
                                                    <div class="am-u-sm-9">
                                                        <input type="text" class="tpl-form-input" id="username" style="color:gray;" name="username" readonly="readonly" placeholder="请输入账号">
                                                ...
                                                <div class="am-form-group">
                                                        <label for="user-name" class="am-u-sm-3 am-form-label">状态 <span
                                                            class="tpl-form-line-small-title">shenfen</span></label>
                                                    <div class="am-u-sm-9">
                                                        <input type="text" class="tpl-form-input" id="status" style="color:gray;" name="status" placeholder="请输入身份">
                                                ...
                                                <div class="am-form-group">
                                                    <label for="user-name" class="am-u-sm-3 am-form-label">地址 <span
                                                            class="tpl-form-line-small-title">email</span></label>
                                                    <div class="am-u-sm-9">
                                                        <input type="text" class="tpl-form-input" style="color:gray;" id="message" name="message" placeholder="请输入邮箱">
                          ...
                          <script>
                              function updateBuser()
                              {
                                ...
                                if(!files[0])
                                {
                                  ...
                                  $.ajax({
                                      url       :   "<?php echo url('buseruser/updatebuser'); ?>",
                                      type      :   "post",
                                      data      :   formData,
                                      dataType  :   "json",
                                      cache     :   false,
                                      ...
                                      success   :   function(data){
                                        if (data.code === 1) {
                                            alert(data.message);
                                            window.location.href = "<?php echo url('buseruser/buserlist'); ?>";
                                        } else {
                                            alert(data.message);
                                        }
                                      }
...
<script>
    function insert()
    {
        window.location.href = "<?php echo url('buseruser/insert'); ?>";
    }
</script>
...
<script>
        function delet(id)
        {
            ...
            {
                $.ajax({
                    url     :   "<?php echo url('buseruser/delete'); ?>",
                    type    :   "post",
                    data    :   {"Id":id},
                    dataType:   "json",
                    success :   function(data){
